  ...
  constructor(props) {
    ...
    this.state = {
      ...
      permissions: {
        ...
        customfieldsAll: "true",
        customfieldscreate: "true",
        customfieldsview: "true",
        customfieldsedit: "true",
        customfieldsdelete: "true",
        suppliersAll: "true",
          ...
          <div>
            <div>
              ...
              <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800" name="creategroup"> {t('group.creategroup')}</h1>
                                ...
                                <div class="form-group row">
                                  <div class="col-sm-5 mb-3 mb-sm-0">
                                    ...
                                    <input type="text" class="form-control " id="name" name="name"
                                      placeholder={t('group.GroupName')} onChange={this.myChangeHandler} />
