...
var ResponseStatus = "";
class TicketIssuesCreate extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
       value: "en",
  ...
  async componentDidMount() {
    ...
    const [talent_group_id] = await Promise.all([
      axios.get(url),
    ]);
    this.setState({
      ...
      return (
        <div>
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800" name="createissue">{t('ticketissue.createissue')}<span></span></h1>
...
export default withTranslation()(TicketIssuesCreate);