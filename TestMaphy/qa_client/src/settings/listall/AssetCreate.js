...
class ListAllCreate extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      //inputs: [],
      ...
      showNotificationsModalStatus: false,
  ...
  validateFormModel() {
    ...
    if (!state["manufacturer_id"]) {
      formIsValid = false;
      errors["manufacturer_id"] = "*Please enter manufacturer.";
    }
  ...
  validateFormStatus() {
    ...
    if (!state["status_id"]) {
      formIsValid = false;
      errors["status_id"] = "*Please enter status type.";
    }
    this.setState({
      errors: errors
    });
  ...
  {
    formIsValid = false;
    errors["warranty_months"] = "*Please enter warranty";
  }
  else{
  ...
  deteteRow = index => {
    this.setState({
      DataField: this.state.DataField.filter(
  ...
  clickOnDelete(record) {
    this.setState({
      DataField: this.state.DataField.filter(r => r !== record)
    });
  }
  ...
  render() {
    ...
    const { ShowCreate, mainPage,showNotifications, showNotificationsModal, showNotificationsModalStatus, showNotificationsSupplier, showNotificationsLocation } = this.state;
    if (ShowCreate) {
      return (
        <div>

          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 custommain-title" name="createasset">{t('AssetsListall.createasset')}</h1>
                          ...
                          <form class="user" onSubmit={this.mySubmitHandler}>
                            ...
                            <div class="form-group row">
                              <div class="col-sm-8 mb-3 mb-sm-0">
                                ...
                                <input type="text" class="form-control "
                                  name="serial" id="serial" aria-describedby="emailHelp"
                                  placeholder={t('AssetsListall.serial')} onChange={this.myChangeHandler} />
                              </div>
                            ...
                            <div class="form-group row">
                              <div class="col-sm-8 mb-3 mb-sm-0">
                                ...
                                <select ref="model_id" class="form-control" onChange={this.myChangeHandler} id="model_id" name="model_id" >
                                ...
                                <div className="errorMsg" style={{ color: "red" }}>{this.state.errors.model_id}</div>
                              </div>
                              <div class="col-sm-4">
                                  ...
                                  <Modal.Body>
                                    ...
                                    <div class="form-group row">
                                      <input type="text" class="form-control form-control-user customdept-location"
                                        name="modelname" id="modelname" aria-describedby="emailHelp"
                                        placeholder={t('newbutton.modelname')} onChange={this.modelChangeHandler}  />
                                      <div className="errorMsg" style={{ color: "red" }}>{this.state.errors.modelname}</div>
                                    </div>
                                    <div class="form-group row">
                                      <select ref="manufacturer_id" class="form-control customdept-location" onChange={this.modelChangeHandler} id="manufacturer_id" name="manufacturer_id" >
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <select ref="category_id" class="form-control customdept-location" onChange={this.modelChangeHandler} id="category_id" name="category_id" >
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <input type="text" class="form-control form-control-user customdept-location"
                                        name="model_number" id="model_number" aria-describedby="emailHelp"
                                        placeholder={t('newbutton.modelnumber')} onChange={this.modelChangeHandler} />
                            ...
                            <div class="form-group row">
                              <div class="col-sm-8 mb-3 mb-sm-0">
                                ...
                                <select ref="status_id" class="form-control" onChange={this.myChangeHandler} id="status_id" name="status_id" >
                              ...
                              <div class="col-sm-4">
                                ...
                                <Modal show={this.state.showStatus} onHide={() => this.handleModalStatus()}>
                                  ...
                                  <Modal.Body>
                                    ...
                                    <div class="form-group row">
                                      <select ref="status_id" class="form-control customdept-location" onChange={this.myChangeHandler} id="status_id" name="status_id" >
                                        <option value="">{t('select.status')}</option>
                            ...
                            <div class="form-group row">
                              <div class="col-sm-8 mb-3 mb-sm-0">
                                ...
                                <input type="Date" class="form-control "
                                  name="purchase_date" id="purchase_date" aria-describedby="emailHelp"
                                  ...
                                  <Modal.Body>
                                    {(() => {
                                      if (showNotificationsSupplier) {
                                        return (
                                          <div class="row">
                                            <div class="col-md-12">
                                              {(NotificationMessageSupplier === "Created successfully")
                                                ? null
                                                : <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    ...
                                    <div class="form-group row">
                                      <input type="text" class="form-control form-control-user"
                                        name="supplier" id="supplier" aria-describedby="emailHelp"
                            ...
                            <div class="form-group row">
                              <div class="col-sm-8 mb-3 mb-sm-0">
                                ...
                                <input type="text" class="form-control "
                                  name="order_number" id="order_number" aria-describedby="emailHelp"
                            ...
                            <div class="form-group row">
                              <div class="col-sm-8 mb-3 mb-sm-0">
                                ...
                                <div class="input-group-append">
                                  <input type="text" class="form-control "
                                    name="purchase_cost" id="purchase_cost" aria-describedby="emailHelp"
                            ...
                            <div class="form-group row">
                              <div class="col-sm-8 mb-3 mb-sm-0">
                                ...
                                <label for="gst" class="customlabel-textcolor">GST in % <i style={{ color: "red" }}>*</i> </label>
                                <div class="input-group-append">
                                  <input type="text" class="form-control "
                                    name="gst" id="gst"
                                    placeholder="GST in %" onChange={this.myChangeHandler}  />

                                </div>
                                <div className="errorMsg" style={{ color: "red" }}>{this.state.errors.gst}</div>
                            ...
                            <div class="form-group row">
                              <div class="col-sm-8 mb-3 mb-sm-0">
                                ...
                                <input type="number" class="form-control "
                                  name="warranty_months" id="warranty_months" aria-describedby="emailHelp"
                                  placeholder={t('AssetsListall.warranty_months')} onChange={this.myChangeHandler}  />
                            ...
                            <div class="form-group row">
                              <div class="col-sm-8 mb-3 mb-sm-0">
                                ...
                                <select ref="location_id" class="form-control" onChange={this.myChangeHandler}
                              ...
                              <div class="col-sm-4">
                                ...
                                <Modal show={this.state.show} onHide={() => this.handleModalLocation()}>
                                  ...
                                  <Modal.Body>
                                    ...
                                    <div class="form-group row">
                                      <input type="text" class="form-control form-control-user customdept-location"
                                        name="location" id="location" aria-describedby="emailHelp"
                                    ...
                                    <div class="form-group row">
                                      <Countries class="form-control" ref="country" name="country" empty={t('select.location')} onChange={this.myChangeHandler} />
                            ...
                            <div class="form-group">
                              <button type="button" name="btnCancel" onClick={this.BackBtnClick} class="btn btn-link text-left" >{t('button.btnCancel')}</button>
                              <button type="submit" name='submit' class="btn-primary" >{t('button.submit')}</button>
                            </div>
                          </form>
...
export default withTranslation()(ListAllCreate);