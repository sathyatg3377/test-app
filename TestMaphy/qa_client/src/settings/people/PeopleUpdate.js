...
class PeopleUpdate extends Component {
    ...
    async componentDidMount() {
        ...
        this.setState({ name: this.props.PeopleData.name });
        this.setState({ jobtitle: this.props.PeopleData.jobtitle });
        this.setState({ email: this.props.PeopleData.email });
        this.setState({ phone: this.props.PeopleData.phone });
        this.setState({ address: this.props.PeopleData.address });
        this.setState({ city: this.props.PeopleData.city });
        this.setState({ state: this.props.PeopleData.state });
        this.setState({ zip: this.props.PeopleData.zip });
        this.setState({ first_name: this.props.PeopleData.first_name });
        this.setState({ company_id: this.props.PeopleData.company.id });
        this.setState({ country: this.props.PeopleData.country });
        this.setState({ department_id: this.props.PeopleData.department.id });
        this.setState({ website: this.props.PeopleData.website });

        this.setState({ manager_id: this.props.PeopleData.manager.id });

        this.setState({ location_id: this.props.PeopleData.location.id });

        this.setState({ language: this.props.PeopleData.language });

        this.setState({ last_name: this.props.PeopleData.last_name });
        this.setState({ username: this.props.PeopleData.username });
        this.setState({ group_id: this.props.PeopleData.groups.rows[0].id});
        this.setState({ chkLogin: this.props.PeopleData.chkLogin });

        this.setState({ chkEmailcredentials: this.props.PeopleData.chkEmailcredentials });

        this.setState({ employee_num: this.props.PeopleData.employee_num });

        this.setState({ notes: this.props.PeopleData.notes });
        this.setState({ talent_group_id: this.props.PeopleData.talent_group_id });
        this.setState({ user_type: this.props.PeopleData.user_type });
        this.setState({ activated: this.props.PeopleData.activated });
    ...
    mySubmitHandler = async (event) => {
        ...
        if (this.validateForm()) {
                await axios({
                    method: 'put',
                    url: Domain + '/users/' + this.props.PeopleData.id,
                    data: JSON.stringify({
                        ...
                        talent_group_id: this.state.talent_group_id? this.state.talent_group_id:null,
                        user_type: this.state.user_type?this.state.user_type:null
                    }),
                    headers: {
                    ...
                    <div>
                        <div>
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800 custommain-title">{t('people.update')}</h1>
                                                        ...
                                                        <form class="user" onSubmit={this.mySubmitHandler}>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                                    ...
                                                                    <input type="first_name" class="form-control " id="first_name" name="first_name" value={this.state.first_name}
                                                                ...
                                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                                    ...
                                                                    <input type="last_name" class="form-control " id="last_name" name="last_name" value={this.state.last_name}
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                                    ...
                                                                    <input type="email" class="form-control" id="email" name="email" value={this.state.email} onChange={this.myChangeHandler}
                                                                        placeholder="Email Address" />
                                                                         <div className="errorMsg" style={{ color: "red" }}>{this.state.errors.email}</div>
                                                                    <input type="checkbox" id="email_user" name="email_user" value={this.state.email_user} onChange={this.CheckboxChanged} checked disabled />
                                                                ...
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <input type="text" class="form-control " id="username" name="username" value={this.state.username}
                                                                        placeholder="User Name" onChange={this.myChangeHandler} />
                                                                    <div className="errorMsg" style={{ color: "red" }}>{this.state.errors.username}</div>
                                                                    <input type="checkbox" id="activated" name="activated" value={this.state.activated} onChange={this.CheckboxChanged} />
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-6 ">
                                                                    ...
                                                                    <input type="text" class="form-control " onChange={this.myChangeHandler} value={this.state.employee_num}
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-6 ">
                                                                    ...
                                                                    <input type="text" class="form-control" onChange={this.myChangeHandler} value={this.state.jobtitle}
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                                    ...
                                                                    <input type="text" class="form-control " id="phone" name="phone" value={this.state.phone} onChange={this.myChangeHandler}
                                                                        placeholder="Phone" />
                                                                ...
                                                                <div class="col-sm-6 ">
                                                                    ...
                                                                    <input type="text" class="form-control " id="website" name="website" value={this.state.website} onChange={this.myChangeHandler}
                                                                        placeholder="website"/>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                                    ...
                                                                    <input type="text" class="form-control " id="address" name="address" value={this.state.address} onChange={this.myChangeHandler}
                                                                        placeholder="Address"  />
                                                                ...
                                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                                    ...
                                                                    <input type="text" class="form-control " id="city" name="city" value={this.state.city} onChange={this.myChangeHandler}
                                                                        placeholder="City"  />
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                                    ...
                                                                    <input type="text" class="form-control " id="state" name="state" value={this.state.state} onChange={this.myChangeHandler}
                                                                        placeholder="State"/>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                                    ...
                                                                    <input type="text" class="form-control " id="zip" name="zip" value={this.state.zip} onChange={this.myChangeHandler}
                                                                        placeholder="Zip" />
                                                                ...
                                                                <div class="col-sm-6 ">
                                                                    ...
                                                                    <select ref="group_id" class="form-control" onChange={this.myChangeHandler} id="group_id" value={this.state.group_id} name="group_id" >
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                                    ...
                                                                    <select ref="talent_group_id" class="form-control" onChange={this.myChangeHandler} value={this.state.talent_group_id} id="talent_group_id" name="talent_group_id">
                                                                    ...
                                                                    <div style={{ color: "red" }} >
                                                                        <div className="errorMsg">{this.state.error_talentgroup}</div>
                                                                    </div>
                                                                </div>

                                                                <div class="col-sm-6 ">
                                                                    <label for="user_type" class=" control-label customlabel-textcolor">{t('people.user_type')}</label>
                                                                    <select ref="user_type" class="form-control" onChange={this.myChangeHandler} id="user_type " value={this.state.user_type} name="user_type">
                                                                        <option key="" value="">Select user type</option>
                                                                        <option value="1">Technician</option>
                                                                        <option value="2">Technical Manager</option>
                                                                    </select>
                                                                    <div style={{ color: "red" }} >
                                                                        <div className="errorMsg">{this.state.error_usertype}</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-8 mb-3 mb-sm-0">
                                                                    ...
                                                                    <textarea class="form-control " id="notes" name="notes" value={this.state.notes} onChange={this.myChangeHandler}
                                                                        placeholder="Notes" />
...
export default withTranslation()(PeopleUpdate);