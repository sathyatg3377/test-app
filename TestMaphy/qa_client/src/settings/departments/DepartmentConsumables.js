...
class DepartmentConsumables extends Component {
  constructor(props) {
    super(props)
    this.state = {
  ...
  callServerData() {
    const url = Domain + '/consumables?assigned_to=' + this.props.managerDetails.manager.id +
...
export default DepartmentConsumables;