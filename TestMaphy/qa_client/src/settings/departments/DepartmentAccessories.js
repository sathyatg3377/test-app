...
class DepartmentAccessories extends Component {
  constructor(props) {
    super(props)
    this.state = {
      TableData: [],
  ...
  callServerData() {
    const url = Domain +'/accessories?assigned_to=' + this.props.managerDetails.manager.id +
...
export default DepartmentAccessories;