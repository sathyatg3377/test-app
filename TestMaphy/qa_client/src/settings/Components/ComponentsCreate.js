...
class ComponentsCreate extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      value: "en",
  ...
  render() {
    console.log("render")
    const { showNotifications, ShowCreate, showNotificationsModal, showNotificationsLocation } = this.state;
    const { t } = this.props;
      ...
      return (
        <div>
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 custommain-title">{t('component.create')}</h1>
                            ...
                            <div class="form-group row">
                              <div class="col-sm-8 mb-3 mb-sm-0">
                                ...
                                <input type="text" class="form-control"
                                  name="ComponentsName" id="ComponentsName"
                                  placeholder={t('component.name')} onChange={this.myChangeHandler} />
                              </div>
                            ...
                            <div class="form-group row">
                              <div class="col-sm-8 mb-3 mb-sm-0">
                                ...
                                <input type="date" class="form-control "
                                  ...
                                  placeholder={t('component.purchase_date')} onChange={this.myChangeHandler} />
...
export default withTranslation()(ComponentsCreate);
