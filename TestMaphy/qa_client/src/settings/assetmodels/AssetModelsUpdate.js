...
class AssetModelsUpdate extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      value: "en",
  ...
  componentDidMount() {
    ...
    this.setState({ AssetModelsName: this.props.AssetModelstoUpdate.name });
    this.setState({ model_number: this.props.AssetModelstoUpdate.model_number });
    this.setState({ eol: this.props.AssetModelstoUpdate.eol });
    this.setState({ AssetModelsId: this.props.AssetModelstoUpdate.id });
    this.setState({ manufacturer_id: this.props.AssetModelstoUpdate.manufacturer.id });
    this.setState({ category_id: this.props.AssetModelstoUpdate.category.id });
    this.setState({ depreciation_id: this.props.AssetModelstoUpdate.depreciation.id });
    this.setState({ notes: this.props.AssetModelstoUpdate.notes });
    this.setState({ requestable: this.props.AssetModelstoUpdate.requestable });
  ...
  mySubmitHandler = async (event) => {
    ...
    if (this.validateForm()) {
      await axios({
        method: this.state.editProcess === "Clone" ? "post" : "put",
        url: this.state.editProcess === "Clone" ? Domain + '/models' : Domain + '/models/' + this.state.AssetModelsId,
        data: JSON.stringify({
  ...
  validateForm() {
    ...
    if (!state["eol"]) {
      ...
      if (typeof state["eol"] !== "undefined") {
        if (!validator.isInt(state["eol"].toString(), { gt: 0, lt: 1000 })) {
          formIsValid = false;
  ...
  render() {
    const { showUpdate, showNotificationsModal, showNotificationsCategory, showNotifications } = this.state;
    const { t } = this.props;
    if (showUpdate) {
      return (
        <div>
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 custommain-title">
              {this.state.editProcess === "Update" ? t('assetmodel.update') : t('assetmodel.clone')}</h1>
                          ...
                          <form class="user" onSubmit={this.mySubmitHandler}>
                            <div class="form-group row">
                              ...
                              <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                <input type="text" class="form-control "
                                  value={this.state.AssetModelsName} name="AssetModelsName" id="AssetModelsName"
                                  placeholder={t('assetmodel.name')} onChange={this.myChangeHandler} />
                            ...
                            <div class="form-group row">
                              <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                <select ref="manufacturer_id" class="form-control" onChange={this.myChangeHandler} id="manufacturer_id" value={this.state.manufacturer_id} name="manufacturer_id" >
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                < input type="text" class="form-control "
                                  name="model_number" value={this.state.model_number} id="model_number" placeholder={t('assetmodel.model_number')}
                                  onChange={this.myChangeHandler} />
                              ...
                              <div class="col-sm-6 ">
                                ...
                                <input type="text" class="form-control " name="eol" value={this.state.eol} id="eol" placeholder={t('assetmodel.eol')} onChange={this.myChangeHandler} />
                            ...
                            <div class="form-group row">
                              <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                <select ref="depreciation_id" class="form-control" onChange={this.myChangeHandler} value={this.state.depreciation_id} id="depreciation_id" name="depreciation_id" >
                            ...
                            <div class="form-group row">
                              <div class="col-sm-6">
                                ...
                                <textarea class="form-control " id="notes" value={this.state.notes} name="notes" onChange={this.myChangeHandler}
                            ...
                            <div class="form-group row">
                              <div class="col-sm-6">
                                <input type="checkbox" id="requestable" name="requestable" checked={this.state.requestable} onChange={this.CheckboxChanged} />
...
export default withTranslation()(AssetModelsUpdate);
