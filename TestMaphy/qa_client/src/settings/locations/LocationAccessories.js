...
class LocationAccessories extends Component {
  constructor(props) {
    super(props)
    this.state = {
      TableData: [],
  ...
  callServerData() {
    const url = Domain +'/accessories?location_id=' +this.props.LocationDatatoUpdate.id +
...
export default LocationAccessories;