...
class LocationAssets extends Component {
  ...
  callServerData() {
    const url = Domain + '/hardware?assigned_to=' + this.props.LocationDatatoUpdate.id +
  ...
  render() {
    ...
    const { TableData, sizePerPage, page ,showMain} = this.state;
    const { t } = this.props;
      ...
      return (
        ...
        <div>
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 custommain-title">{t('location.assetsAssigned')}- {this.props.LocationDatatoUpdate.name}</h1>
...
export default  withTranslation()(LocationAssets);