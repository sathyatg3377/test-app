...
class LocationConsumables extends Component {
  constructor(props) {
    super(props)
    this.state = {
  ...
  callServerData() {
    const url = Domain + '/consumables?location_id=' + this.props.LocationDatatoUpdate.id +
...
export default LocationConsumables;