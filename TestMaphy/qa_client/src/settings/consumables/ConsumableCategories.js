...
class ConsumableCategories extends Component {
  constructor(props) {
    super(props)
    this.state = {
value:"en",
 ...
 headerStyle:  { 'white-space' : 'nowrap' }
  ...
  callServerData() {
    const url = Domain + '/consumables?category_id=' + this.props.ConsumablesDatatoUpdate.category.id +
...
if (ShowMain) {
      return (
        <ConsumablesMain showNotifications={this.state.showNotifications} NotificationMessage={this.state.NotificationMessage} />)
...
export default withTranslation()(ConsumableCategories);
