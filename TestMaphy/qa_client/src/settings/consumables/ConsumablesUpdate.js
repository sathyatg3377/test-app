...
class ConsumablesUpdate extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            value: "en",
    ...
    async componentDidMount() {
        ...
        this.setState({ ConsumablesId: this.props.ConsumablesDatatoUpdate.id });
        this.setState({ company_id: this.props.ConsumablesDatatoUpdate.company.id });
        this.setState({ category_id: this.props.ConsumablesDatatoUpdate.category.id });
        this.setState({ manufacturer_id: this.props.ConsumablesDatatoUpdate.manufacturer.id });
        this.setState({ location_id: this.props.ConsumablesDatatoUpdate.location.id });
        this.setState({ model_number: this.props.ConsumablesDatatoUpdate.model_number });
        this.setState({ item_no: this.props.ConsumablesDatatoUpdate.item_no });
        this.setState({ order_number: this.props.ConsumablesDatatoUpdate.order_number });
        this.setState({ purchase_cost: this.props.ConsumablesDatatoUpdate.purchase_cost });
        this.setState({ purchase_date: this.props.ConsumablesDatatoUpdate.purchase_date.formatted });
        this.setState({ qty: this.props.ConsumablesDatatoUpdate.qty });
        this.setState({ min_amt: this.props.ConsumablesDatatoUpdate.min_amt });
    ...
    mySubmitHandler = async (event) => {
        ...
        if (this.validateForm()) {
            await axios({
                method: 'put',
                url: Domain + '/consumables/' + this.state.ConsumablesId,
                data: JSON.stringify({
    ...
    render() {
        const { showNotifications, showUpdate, showNotificationsModal, showNotificationsManufacturer, showNotificationsCategory } = this.state;
        const { t } = this.props;
        if (showUpdate) {
            return (
                <div>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800 custommain-title">{t('consumable.update')}<span></span></h1>
                                                    ...
                                                    <form class="user" onSubmit={this.mySubmitHandler}>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-8 mb-3 mb-sm-0">
                                                                ...
                                                                <input type="text" class="form-control "
                                                                    name="ConsumableName" id="ConsumableName" value={this.state.ConsumableName}
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-8 mb-3 mb-sm-0">
                                                                ...
                                                                <select ref="category_id" class="form-control" onChange={this.myChangeHandler} id="category_id"
                                                                    value={this.state.category_id} name="category_id">
                                                            ...
                                                            <div class="col-sm-4">
                                                                ...
                                                                <Modal show={this.state.showCategory} onHide={() => this.handleModalCategory()}>
                                                                    ...
                                                                    <Modal.Body>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label for="CategoryType" class="customlabel-textcolor">{t('newbutton.categoryname')} </label>

                                                                            <input type="text" class="form-control"
                                                                                name="category" value={this.state.category} id="category"
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label for="CategoryType" class="customlabel-textcolor">{t('select.categorytype')} <i style={{ color: "red" }}>*</i></label>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-8 mb-3 mb-sm-0">
                                                                ...
                                                                <select ref="manufacturer_id" class="form-control" onChange={this.myChangeHandler} id="manufacturer_id"
                                                                    value={this.state.manufacturer_id} name="manufacturer_id" >
                                                                    ...
                                                                    <Modal.Body>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-user customdept-location"
                                                                                name="location" value={this.state.location} id="location"
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-8 mb-3 mb-sm-0">
                                                                ...
                                                                <input type="text" class="form-control "
                                                                    name="model_number" id="model_number" value={this.state.model_number}
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-8 mb-3 mb-sm-0">
                                                                ...
                                                                <input type="text" class="form-control "
                                                                    name="item_no" id="item_no" value={this.state.item_no}
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-8 mb-3 mb-sm-0">
                                                                <label for="text" class="
                                                                 control-label customlabel-textcolor">{t('consumable.min_amt')} <i style={{ color: "red" }}>*</i></label>
...
export default withTranslation()(ConsumablesUpdate);
