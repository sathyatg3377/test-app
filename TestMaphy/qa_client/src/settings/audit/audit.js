...
class audit extends Component {
  ...
  callServerData() {
    const url = Domain + '/audit?limit=' + this.state.sizePerPage +
    ...
    axios.get(url)
      .then((response) => {
         this.setState({AuditReportData: response.data.rows });
        this.setState({ AuditReportDataTotal: response.data.total });
      });
  }
  ...
  render() {
    ...
    const { AuditReportData, sizePerPage, page } = this.state;
    const { t } = this.props
      ...
      <div>
        <div>
          <div >
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h6 class="h3 mb-0 text-gray-800 custommain-title"> {t('app.auditreports')}</h6>
            {/* <div class="row mb-0">
                <div class="col">
        ...
        <div >
              ...
              <RemoteAll
                ...
                totalSize={this.state.AuditReportDataTotal}
                columns={columns}
                CSVExport={CSVExport}
