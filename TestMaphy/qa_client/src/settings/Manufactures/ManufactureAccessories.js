...
class ManufactureAccessories extends Component {
  constructor(props) {
    super(props)
    this.state = {
      TableData: [],
  ...
  callServerData() {
     const url = Domain +'/accessories?manufacturer_id=' + this.props.ManufactureDetails.id +
...
export default ManufactureAccessories;
