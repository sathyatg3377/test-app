...
var ResponseStatus = "";
class CustomFieldsCreate extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
        value: "en",
...
onLanguageHandle = (event) => {
 ...
 console.log('this is', this)
   ...
   <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 custommain-title" name="createcompany" >Create Custom Field <span></span></h1>
      ...
      return (
        <CustomFieldsMain showNotifications={this.state.showNotifications} NotificationMessage={NotificationMessage} />
      );
    }
  }
};

export default  withTranslation()(CustomFieldsCreate);