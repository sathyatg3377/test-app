...
class CustomFieldsMain extends Component {
  constructor(props) {
    super(props)
    this.state = {
  ...
  callServerData() {
    const url = Domain + '/customfields?limit=' + this.state.sizePerPage +
  ...
  render() {
    ...
    if (ShowCreate) {
      ...
      return (
        <CustomFieldsUpdate companyDetails={this.state.companyDetails} />
      )
    }
    // else if (ShowDetails) {
    //   return (
    //     <CustomFieldsDetails companyDetails={this.state.companyDetails} />
    //   )
    // }
    else {
      return (
        <div>
          ...
          <div>
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800 custommain-title" name="companytitle">Custom Field</h1>
...
export default withTranslation()(CustomFieldsMain);
