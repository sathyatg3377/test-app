...
class AccessoriesCategory extends Component {
  constructor(props) {
    super(props)
    this.state = {
value: "en",
...
headerStyle:  { 'white-space' : 'nowrap' }
  ...
  callServerData() {
    const url = Domain + '/accessories?category_id=' + this.props.CategoriesDatatoUpdate.category.id +
  ...
  deleteAccessories = (id) => {
    ...
    axios.delete(url)
      .then((response) => {
        ...
        this.setState({ AccessoriesData: this.state.AccessoriesData.filter(result => result.id !== id) });
      })
  }
...
onLanguageHandle = (event) => {
 ...
 {columns
    ...
    if (ShowCreate) {
      ...
      console.log("CategoriesDatatoUpdate", this.props.CategoriesDatatoUpdate)
      return (
...
export default withTranslation()(AccessoriesCategory);
