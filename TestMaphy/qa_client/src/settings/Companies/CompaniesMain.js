...
class CompaniesMain extends Component {
  ...
  callServerData() {
    const url = Domain + '/companies?limit=' + this.state.sizePerPage +
  ...
  render() {
    ...
    if (ShowCreate) {
      ...
      return (
        <CompaniesUpdate companyDetails={this.state.companyDetails} />
      )
    }
    else if (ShowDetails) {
      return (
        ...
        <div>
          ...
          <div>
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800 custommain-title" name="companytitle">{t('company.companytitle')}</h1>
...
export default withTranslation()(CompaniesMain);
