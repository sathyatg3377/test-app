...
class SuppliersAccessories extends Component {
  constructor(props) {
    super(props)
    this.state = {
      TableData: [],
  ...
  callServerData() {
     const url = Domain +'/accessories?supplier_id=' + this.props.SuppliersDetails.id +
...
export default SuppliersAccessories;
