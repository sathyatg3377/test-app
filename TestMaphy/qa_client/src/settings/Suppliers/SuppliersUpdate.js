...
var ResponseStatus = "";
class SuppliersUpdate extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            errors: {},
    ...
    componentDidMount() {
        this.setState({ SuppliersName: this.props.SupplierstoUpdate.name });
        this.setState({ address: this.props.SupplierstoUpdate.address });
        this.setState({ address2: this.props.SupplierstoUpdate.address2 });
        this.setState({ city: this.props.SupplierstoUpdate.city });
        this.setState({ state: this.props.SupplierstoUpdate.state });
        this.setState({ country: this.props.SupplierstoUpdate.country });
        this.setState({ phone: this.props.SupplierstoUpdate.phone });
        this.setState({ email: this.props.SupplierstoUpdate.email });
        this.setState({ contact: this.props.SupplierstoUpdate.contact });
        this.setState({ url: this.props.SupplierstoUpdate.url });
        this.setState({ SuppliersId: this.props.SupplierstoUpdate.id });

        this.setState({ zip: this.props.SupplierstoUpdate.zip });
        this.setState({ fax: this.props.SupplierstoUpdate.fax });

        this.setState({ notes: this.props.SupplierstoUpdate.notes });
    }
    ...
    mySubmitHandler = async (event) => {
        ...
        await axios({
            method: 'put',
            url: Domain + '/suppliers/' + this.state.SuppliersId,
            data: JSON.stringify({
            ...
            return (
                <div>
                      <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800 custommain-title">{t('supplier.update')}</h1>
                                                    ...
                                                    <form class="user" onSubmit={this.mySubmitHandler}>
                                                            ...
                                                            <div class="col-sm-8 mb-3 mb-sm-0">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    value={this.state.SuppliersName} name="SuppliersName" id="SuppliersName" 
                                                                    placeholder={t('placeholder.vendorname')} onChange={this.myChangeHandler} />
                                                                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-8 mb-3 mb-sm-0">
                                                                ...
                                                                <input type="text" class="form-control"  name="address" id="address" value={this.state.address} 
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-8 mb-3 mb-sm-0">
                                                                <input type="text" class="form-control "
                                                                name="address2" id="address2" value={this.state.address2}   placeholder={t('placeholder.address')} onChange={this.myChangeHandler}  />
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-8 mb-3 mb-sm-0">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="city" id="city" value={this.state.city}
                                                                    placeholder={t('placeholder.city')} onChange={this.myChangeHandler}  />
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-8 mb-3 mb-sm-0">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    placeholder={t('placeholder.state')} onChange={this.myChangeHandler}  />
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-8 mb-3 mb-sm-0">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="zip" id="zip" aria-describedby="emailHelp" value={this.state.zip}
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-8 mb-3 mb-sm-0">
                                                                ...
                                                                <input type="text" class="form-control" value={this.state.contact}
                                                        ...
                                                        <div class="form-group row">
                                                         ...
                                                         <div className="errorMsg" style={{ color: "red" }}>{this.state.errors.phone}</div>
                                                            ...
                                                            <div class="col-sm-8 mb-3 mb-sm-0">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="email" id="email" value={this.state.email} aria-describedby="emailHelp"
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-8 mb-3 mb-sm-0">
                                                                ...
                                                                <input type="text" class="form-control "
                                                                    name="url" id="url" aria-describedby="emailHelp" value={this.state.url}
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-8 mb-3 mb-sm-0">
                                                                ...
                                                                <textarea class="form-control " id="notes" name="notes" value={this.state.notes}
                                                                    onChange={this.myChangeHandler} placeholder={t('placeholder.notes')}  />
                                                            </div>
...
export default withTranslation()(SuppliersUpdate);
